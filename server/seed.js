...
async function main() {
  ...
  const iSeed = [
    ...
    ['Baku', 'Azerbaijan', '5N/6D · 7N/8D', 'Flame towers & Caspian coast', 'Modern flame towers, old city walls and the Caspian coastline.', null, null, 'https://images.unsplash.com/photo-1547447134-cd3f5c716030?w=500&h=360&fit=crop', '[]', 0, 'active'],
    ['Dubai', 'UAE', '5N/6D · 6N/7D', 'Skyline, desert & souks', 'Futuristic skyline, desert safaris and traditional souks.', null, null, 'https://images.unsplash.com/photo-1518684079-3c830dcef090?w=500&h=360&fit=crop', '[]', 1, 'active'],
  ...
  const dom = db.prepare(`INSERT INTO domestic_packages
    ...
    VALUES (?,?,?,?,?,?,?,1,1,1,1,?,?,?,?)`)
  const dSeed = [
    ['Kashmir & Himachal', 'Jammu & Kashmir / Himachal Pradesh', '6N/7D · 7N/8D', 'All seasons', 'Dal Lake & pine valleys', 'Shikara rides on Dal Lake, alpine pine valleys and Himalayan serenity.', null, '["Srinagar","Gulmarg","Pahalgam","Kullu","Manali"]', 'https://images.unsplash.com/photo-1610041321327-b794c052db27?w=500&h=360&fit=crop', '[]', 'active'],
    ...
    ['Seven Sisters', 'North East India', '5N/6D · 7N/8D', 'All seasons', 'Arunachal · Assam · Meghalaya · Manipur · Mizoram · Nagaland · Tripura', 'A journey through the seven northeastern states of India.', null, '["Meghalaya Caves","Kaziranga","Tea Gardens","Tribal Culture"]', 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=500&h=360&fit=crop', '[]', 'active'],
    ['Sikkim', 'Sikkim', '5N/6D · 7N/8D', 'All seasons', 'Tsomgo Lake & Kanchenjunga', 'Himalayan monasteries, Tsomgo Lake and views of Kanchenjunga.', null, '["Gangtok","Tsomgo Lake","Nathula Pass","Monasteries"]', 'https://images.unsplash.com/photo-1465056836041-7f43ac27dcb5?w=500&h=360&fit=crop', '[]', 'active'],
    ...
    ['Manali – Leh Biking', 'Himachal Pradesh / Ladakh', '8D/7N', 'Jun – Sep', 'Delhi–Srinagar · 3 Star Hotels/Camps · Inner Line Permit', 'Epic biking expedition from Manali to Leh with hotels and camps.', null, '["Biking","Camping","Inner Line Permit","Mountain Passes"]', 'https://images.unsplash.com/photo-1544731612-de7f96afe55f?w=500&h=360&fit=crop', '[]', 'active'],
